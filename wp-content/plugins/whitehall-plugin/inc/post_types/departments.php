 ...
 * @author   Wptech
 */
class Departments extends Post_Type {

	protected $post_type = 'department';
	...
	public static function init() {
		...
		self::instance()->menu_name = esc_html__( 'Departments', 'whitehall' );
		self::instance()->singular  = esc_html__( 'Department', 'whitehall' );
		self::instance()->plural    = esc_html__( 'Departments', 'whitehall' );
