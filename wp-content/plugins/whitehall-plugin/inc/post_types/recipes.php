 ...
 * @author   Wptech
 */
class Recipes extends Post_Type {

	protected $post_type = 'recipes';
	...
	public static function init() {
		...
		self::instance()->menu_name = esc_html__( 'Recipes', 'whitehall' );
		self::instance()->singular  = esc_html__( 'Recipe', 'whitehall' );
		self::instance()->plural    = esc_html__( 'Recipes', 'whitehall' );
