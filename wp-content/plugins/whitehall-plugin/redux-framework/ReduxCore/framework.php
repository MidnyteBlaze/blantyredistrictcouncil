                ...
                if ( ! empty ( $field['required'] ) ) {
                    if ( isset ( $field['required'][0] ) ) {
                        if ( ! is_array( $field['required'][0] ) && count( $field['required'] ) == 3 ) {
                            $parentValue = whitehall_set( $GLOBALS[ $this->args['global_variable'] ], $field['required'][0] );
                            ...
                            foreach ( $field['required'] as $required ) {
                                if ( ! is_array( $required[0] ) && count( $required ) == 3 ) {
                                    $parentValue = whitehall_set(whitehall_set($GLOBALS, whitehall_set($this->args, 'global_variable' ) ), whitehall_set($required,'0') );
