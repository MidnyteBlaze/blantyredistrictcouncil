...
class Testimonials_V1 extends Widget_Base {
    ...
    public function get_name() {
        return 'whitehall_testimonials_v1';
    }
    ...
    public function get_title() {
        return esc_html__( 'Testimonials V1', 'whitehall' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'testimonials_v1',
            [
                'label' => esc_html__( 'Testimonials V1', 'whitehall' ),
            ]
        );
		$this->add_control(
            'bg_image',
    ...
    protected function render() {
        ...
        <!-- testimonial-section -->
        <section class="testimonial-section centred" style="background-image: url(<?php echo wp_get_attachment_url($settings['bg_image']['id']); ?>);">
            <div class="auto-container">
                <div class="three-item-carousel owl-carousel owl-theme owl-dots-none owl-nav-none">
                    <?php while ( $query->have_posts() ) : $query->the_post(); ?>
                    <div class="testimonial-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><?php the_post_thumbnail('whitehall_120x120'); ?></figure>
                            <div class="text">
