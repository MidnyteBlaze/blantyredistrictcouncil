 ...
 * @since 1.0.0
 */
class About_Our_Government extends Widget_Base {
    ...
    public function get_name() {
        return 'whitehall_about_our_government';
    }
    ...
    public function get_title() {
        return esc_html__( 'About Our Government', 'whitehall' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'About Our Government', 'whitehall' ),
            ]
        );
		$this->add_control(
            'bg_image',
    ...
    protected function render() {
        ...
        <!-- feature-section -->
        <section class="feature-section sec-pad" style="background-image: url(<?php echo wp_get_attachment_url($settings['bg_image']['id']); ?>);">
                        ...
                        <div class="feature-block-two wow fadeInUp animated animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    ...
                                    <div class="light-icon"><i class="<?php echo esc_attr( $item['icon'] ); ?>"></i></div>
                                    <h4><a href="<?php echo esc_url( $item['btn_link']['url'] ); ?>"><?php echo wp_kses( $item['title'], true ); ?></a></h4>
									
									<?php if($item['btn_link']['url'] and $item['btn_title']) { ?>
                                    <div class="btn-box"><a href="<?php echo esc_url( $item['btn_link']['url'] ); ?>"><?php echo wp_kses($item['btn_title'], true); ?><i class="flaticon-right-arrow"></i></a></div>
									<?php } ?>
                                </div>
                            </div>
                        </div>
