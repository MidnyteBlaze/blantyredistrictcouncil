 ...
 * @since 1.0.0
 */
class About_Services extends Widget_Base {
    ...
    public function get_name() {
        return 'whitehall_about_services';
    }
    ...
    public function get_title() {
        return esc_html__( 'About Services', 'whitehall' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'about_services',
            [
                'label' => esc_html__( 'About Services', 'whitehall' ),
            ]
        );
		$this->add_control(
            'subtitle',
		...
		$this->add_control(
            'slides',
            [
                'label'   => esc_html__( 'Services', 'whitehall' ),
		...
		$this->start_controls_section(
            'city_residents_tab',
            [
                'label' => esc_html__( 'City Residents', 'whitehall' ),
            ]
        );
		$this->add_control(
            'icon1',
		...
		$this->start_controls_section(
            'city_visitors_tab',
            [
                'label' => esc_html__( 'City Visitors', 'whitehall' ),
            ]
        );
		$this->add_control(
            'image',
                            ...
                            <div class="content-box">
                                <div class="left-column">
                                    <div class="inner centred">
                                        ...
                                        <h6><?php echo wp_kses( $settings['subtitle1'], true ); ?></h6>
                                ...
                                <div class="right-column">
                                    <figure class="image-box">
                                        <img src="<?php echo wp_get_attachment_url($settings['image']['id']); ?>" alt="<?php esc_html_e('Awesome Image', 'whitehall'); ?>">
										
										<?php if($settings['url']) { ?>
                                        <a href="<?php echo esc_url( $settings['url'] ); ?>"><i class="fal fa-angle-left"></i></a>
										<?php } ?>
                                    </figure>
                                    <div class="inner centred">
                                        <div class="icon-box"><i class="<?php echo esc_attr( $settings['icon2'] ); ?>"></i></div>
                                        <h6><?php echo wp_kses( $settings['subtitle2'], true ); ?></h6>
