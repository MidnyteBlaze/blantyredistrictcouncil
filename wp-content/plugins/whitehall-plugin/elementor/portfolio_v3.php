 ...
 * @since 1.0.0
 */
class Portfolio_V3 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Portfolio V3', 'whitehall');
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'portfolio_v3',
            [
                'label' => esc_html__('Portfolio V3', 'whitehall'),
            ]
        );
		$this->add_control(
            'subtitle',
    ...
    protected function render() {
        ...
        if($query->have_posts())
        {
                ...
                foreach( (array)$post_terms as $pos_term )
					...
					if($post_terms)
						foreach($post_terms as $p_term)
							...
							if($dimention == 'normal_height')
							{
								$image_size = 'whitehall_370x265';
								$class = 'col-lg-4 col-md-6 col-sm-12';
							}
							else if($dimention == 'extra_width')
							{
								$image_size = 'whitehall_770x560'; 
								$class = 'col-lg-8 col-md-6 col-sm-12';
							}
							else
							{
								$image_size = 'whitehall_370x560';
								$class = 'col-lg-4 col-md-6 col-sm-12';
							} ?>
			...
			<!-- portfolio-section -->
			<section class="portfolio-section portfolio-3 sec-pad centred">
