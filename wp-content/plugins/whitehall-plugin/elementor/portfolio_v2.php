 ...
 * @since 1.0.0
 */
class Portfolio_V2 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Portfolio V2', 'whitehall');
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'portfolio_v2',
            [
                'label' => esc_html__('Portfolio V2', 'whitehall'),
            ]
        );
		$this->add_control(
            'subtitle',
						...
						foreach($post_terms as $p_term)
							...
							<div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all <?php echo esc_attr($term_slug); ?>">
								<div class="portfolio-block-two">
									<div class="inner-box">
										<figure class="image-box"><?php the_post_thumbnail('whitehall_370x320'); ?></figure>
