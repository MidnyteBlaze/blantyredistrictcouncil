...
class Team_V1 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Team V1', 'whitehall' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'team_v1',
            [
                'label' => esc_html__( 'Team V1', 'whitehall' ),
            ]
        );
		$this->add_control(
            'style',
    ...
    protected function render() {
		...
		<!-- team-section -->
        <section class="team-section sec-pad <?php if($settings['style'] == 'style1') echo 'bg-color-1'; ?>">
