 ...
 * @since 1.0.0
 */
class Departments_V2 extends Widget_Base {
    ...
    public function get_name() {
        return 'whitehall_departments_v2';
    }
    ...
    public function get_title() {
        return esc_html__( 'Departments V2', 'whitehall' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'departments_v2',
            [
                'label' => esc_html__( 'Departments V2', 'whitehall' ),
            ]
        );
		$this->add_control(
            'left_bg_image',
    ...
    protected function render() {
        ...
        <!-- explore-style-two -->
        <section class="explore-style-two sec-pad pb-140 centred"> 
            <div class="pattern-layer">
                <div class="pattern-1" style="background-image: url(<?php echo wp_get_attachment_url($settings['left_bg_image']['id']); ?>);"></div>
                <div class="pattern-2" style="background-image: url(<?php echo wp_get_attachment_url($settings['right_bg_image']['id']); ?>);"></div>
            </div>
            <div class="auto-container">
                ...
                <div class="four-item-carousel owl-carousel owl-theme owl-nav-none">
                    ...
                    <div class="explore-block-two">
                        <div class="inner-box">
                            <figure class="image-box"><?php the_post_thumbnail('whitehall_270x370'); ?></figure>
                            ...
                            <div class="overlay-content">
                                ...
                                <div class="text">
                                    <h4><?php the_title(); ?></h4>
                                    <a href="<?php echo esc_url(get_post_meta( get_the_id(), 'ext_url', true )); ?>"><?php esc_html_e('Read More', 'whitehall'); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
