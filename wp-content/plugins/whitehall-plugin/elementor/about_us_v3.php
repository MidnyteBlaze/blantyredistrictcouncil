...
class About_Us_V3 extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'About Us V3', 'whitehall' );
    }
                ...
                <div class="row clearfix align-items-center">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 inner-column">
                        ...
                        <div class="feature-block-one">
                            <div class="inner-box">
                                <figure class="image"><img src="<?php echo wp_get_attachment_url($item['bg_image']['id']); ?>" alt="<?php esc_html_e('Awesome Image', 'whitehall'); ?>"></figure>
                                <div class="text">
