 ...
 * @since 1.0.0
 */
class Departments_V3 extends Widget_Base {
    ...
    public function get_name() {
        return 'whitehall_departments_v3';
    }
    ...
    public function get_title() {
        return esc_html__( 'Departments V3', 'whitehall' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            'departments_v3',
            [
                'label' => esc_html__( 'Departments V3', 'whitehall' ),
            ]
        );
        $this->add_control(
            'subtitle',
