...
<div class="boxed_wrapper">
				...
				<div class="top-inner clearfix">
					<div class="left-column pull-left clearfix">
						<ul class="info-list clearfix">
							...
							<li><i class="flaticon-phone-with-wire"></i><a href="tel:<?php echo esc_attr(phone_number($options->get('phone_number_v2'))); ?>"><?php echo wp_kses($options->get('phone_number_v2'), $allowed_html); ?></a></li>
							<?php } ?>
							
							<?php if( $options->get('show_working_hours_v2') ) { ?>
							<li><i class="flaticon-fast"></i><?php echo wp_kses($options->get('working_hours_v2'), $allowed_html); ?></li>
							<?php } ?>
						</ul>
					</div>
					...
					<div class="menu-area clearfix pull-right">
						...
						<div class="menu-right-content clearfix">
							<ul class="other-option clearfix">
								...
								<?php if( $options->get('show_sidebar_v2') ) { ?>
								<li class="nav-box">
	...
	<div class="mobile-menu">
		...
		<nav class="menu-box">
			...
			<?php if( $options->get('show_mobile_menu_v2') ) { ?>
			<div class="contact-info">
				...
				<ul>
					...
					<li><a href="mailto:<?php echo sanitize_email($options->get('mobile_email_address_v2')); ?>"><?php echo sanitize_email($options->get('mobile_email_address_v2')); ?></a></li>
					<?php } ?>
				</ul>
			</div>
					...
					<div class="sidebar-info-contents">
						<div class="content-inner">
							...
							<div class="content-box">
								<h4><?php echo wp_kses($options->get('sidebar_title_v2'), $allowed_html); ?></h4>
								<div class="booking-form">
									<?php echo do_shortcode($options->get('sidebar_cf7_v2')); ?>
								</div>
							</div>
							<div class="contact-info">
								<h4><?php echo wp_kses($options->get('sidebar_contact_info_title_v2'), $allowed_html); ?></h4>
								<ul>
