...
<div class="boxed_wrapper">
				...
				<div class="top-inner clearfix">
					<div class="left-column pull-left clearfix">
						<ul class="info-list clearfix">
							...
							<li><i class="flaticon-phone-with-wire"></i><a href="tel:<?php echo esc_attr(phone_number($options->get('phone_number_v3'))); ?>"><?php echo wp_kses($options->get('phone_number_v3'), $allowed_html); ?></a></li>
							<?php } ?>
							
							<?php if( $options->get('show_working_hours_v3') ) { ?>
							<li><i class="flaticon-fast"></i><?php echo wp_kses($options->get('working_hours_v3'), $allowed_html); ?></li>
							<?php } ?>
						</ul>
					</div>
					<div class="right-column pull-right clearfix">
						...
						<?php if($options->get( 'show_social_media_v3' )) {
						$icons = $options->get( 'social_media_v3' );
						if ( ! empty( $icons ) ) { ?>
					...
					<div class="menu-area clearfix pull-right">
						...
						<div class="menu-right-content clearfix">
							<ul class="other-option clearfix">
								...
								<?php if( $options->get('show_sidebar_v3') ) { ?>
								<li class="nav-box">
	...
	<div class="mobile-menu">
		...
		<nav class="menu-box">
			...
			<?php if( $options->get('show_mobile_menu_v3') ) { ?>
					...
					<div class="sidebar-info-contents">
						<div class="content-inner">
							...
							<div class="content-box">
								<h4><?php echo wp_kses($options->get('sidebar_title_v3'), $allowed_html); ?></h4>
								<div class="booking-form">
									<?php echo do_shortcode($options->get('sidebar_cf7_v3')); ?>
								</div>
							</div>
							<div class="contact-info">
								<h4><?php echo wp_kses($options->get('sidebar_contact_info_title_v3'), $allowed_html); ?></h4>
								<ul>
									<?php if($options->get('sidebar_address_v3')) { ?>
									<li><?php echo wp_kses($options->get('sidebar_address_v3'), $allowed_html); ?></li>
									<?php } ?>
									
									<?php if($options->get('sidebar_phone_number_v3')) { ?>
									<li><a href="tel:<?php echo esc_attr(phone_number($options->get('sidebar_phone_number_v3'))); ?>"><?php echo wp_kses($options->get('sidebar_phone_number_v3'), $allowed_html); ?></a></li>
									<?php } ?>
									
									<?php if($options->get('sidebar_email_address_v3')) { ?>
									<li><a href="mailto:<?php echo sanitize_email($options->get('sidebar_email_address_v3')); ?>"><?php echo sanitize_email($options->get('sidebar_email_address_v3')); ?></a></li>
									<?php } ?>
								</ul>
							</div>
							
							<?php if($options->get( 'show_sidebar_social_media_v3' )) {
							$icons = $options->get( 'sidebar_social_media_v3' );
							if ( ! empty( $icons ) ) { ?>
							<ul class="social-box">
								<?php foreach ( $icons as $h_icon ) {
								$header_social_icons = json_decode( urldecode( whitehall_set( $h_icon, 'data' ) ) );
