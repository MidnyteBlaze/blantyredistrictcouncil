...
get_header();
global $wp_query;
$data  = \WHITEHALL\Includes\Classes\Common::instance()->data( 'search' )->get();
			...
			<div class="content-side <?php echo esc_attr( $class ); ?>">
				<div class="blog-classic-content">
					...
					<div class="search-notfound">
						<h3><?php printf(esc_html__( 'No result found for "%s"', 'whitehall' ), get_search_query()); ?></h3>
						<p class="m-b30"><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'whitehall' ); ?></p>
						<div class="sidebar">
